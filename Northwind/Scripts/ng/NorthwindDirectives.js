(function () {
    ...
    NorthwindDirectives.directive('jjArena', ['d3Service', function (d3Service) {
        return {
            restrict: 'EA',
            scope: {
                data: "=",
    ...
    NorthwindDirectives.directive('jjTimeseries', ['d3Service', '$window', 'd3LegendService', function (d3Service, $window, d3LegendService) {
        return {
            restrict: 'EA',
            scope: {
                data: "=",
    ...
    NorthwindDirectives.directive('jjMap', ['d3Service','topojsonService', '$window', function (d3Service,topojsonService, $window) {
        return {
            restrict: 'EA',
            scope: {
                json: "=",
